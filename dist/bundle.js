...
class Todo {
	constructor(name, description, dueDate, priority) {
		(this.name = name),
			...
			(this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dueDate, 'yyyy-MM-dd', new Date())),
	...
	changeDueDate(newDate) {
		this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(newDate, 'yyyy-MM-dd');
	}
...
const createNewTask = (name, description, date, priority) => {
	const todo = new _todo__WEBPACK_IMPORTED_MODULE_0__["default"](name, description, date, priority);
	_storage__WEBPACK_IMPORTED_MODULE_2__["default"].tasks.push(todo);
	_storage__WEBPACK_IMPORTED_MODULE_2__["default"].saveToLocalStorage();
	return todo;
};

const createNewProject = (name) => {
	const project = new _project__WEBPACK_IMPORTED_MODULE_1__["default"](name);
	_storage__WEBPACK_IMPORTED_MODULE_2__["default"].projects.push(project);
	_storage__WEBPACK_IMPORTED_MODULE_2__["default"].saveToLocalStorage();
};
